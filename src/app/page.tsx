            ...
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 10.15 : 1}>
                <p>
                  ...
                  Udbhava 2025 is where innovation meets imagination. From the
                  flagship Hackathon – Reality Rewritten to a galaxy of
                  thrilling competitions, Udbhava invites you to explore,
                  create, and celebrate the future.
                </p>
              </Copy>
            </div>
            <AnimatedButton
